...
/**
 * Class Africa_DMM_Menu
 */
class Africa_DMM_Menu {

    public $token = 'africa_dmm';
    public $page_title = 'Africa DMM';

    private static $_instance = null;

    /**
     * Africa_DMM_Menu Instance
     *
     * Ensures only one instance of Africa_DMM_Menu is loaded or can be loaded.
     *
     * @since 0.1.0
     * @static
     * @return Africa_DMM_Menu instance
     */
    ...
    public function __construct() {
        ...
        $this->page_title = __( 'Africa DMM', 'africa-dmm' );
    } // End __construct()
    ...
    public function content() {
        ...
        <div class="wrap">
            ...
            switch ( $tab ) {
                case 'general':
                    $object = new Africa_DMM_Tab_General();
                    $object->content();
                    break;
                case 'second':
                    $object = new Africa_DMM_Tab_Second();
                    $object->content();
                    break;
                default:
                    break;
...
class Africa_DMM_Tab_General {
    ...
    public function main_column() {
        $token = Africa_DMM_Menu::instance()->token;
